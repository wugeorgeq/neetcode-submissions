class Solution {
    fun groupAnagrams(strs: Array<String>): List<List<String>> {
        // make faster by using a hashtable thing instead of sorting. counts of each char
        ...
        //ok so just sorting the string is more kotliny lets try that
        // return strs.groupBy { it.toCharArray().sorted() }.values.toList()


        /*
        ok now lets try groupBy
        */
        // return strs.groupBy { it.toCharArray().apply { sort() }.concatToString() }.values.toList()
        ...
        */
        ...
        // strs.forEach { word ->
        //     // Create a proper String key from the sorted characters, where sort() is efficient and does it in place
